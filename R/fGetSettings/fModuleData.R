...
fModuleData <- function(Settings) {
  ...
  list(
    ...
    '6FD' = list(Print = .PrintModuleMessage("6FD", Settings),
                 ...
                 Failure = "Incorrect, module remains locked."),
    'ENC' = list(Print = .PrintModuleMessage("ENC", Settings),
    ...
    'PKR' = list(Print = .PrintModuleMessage("PKR", Settings),
                 ...
                 Failure = "Incorrect, module remains locked."),
    'SPO' = list(Print = .PrintModuleMessage("SPO", Settings),
                 Hint = paste("If you are not sure where to start, ask a colleague or", Settings$BBEGName, "what a .shp file is."),
    ...
    'TIM' = list(Print = .PrintModuleMessage("TIM", Settings),
